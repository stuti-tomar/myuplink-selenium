...
public class BaseTest {
	...
	public void browserSetup() {
	    ...
	    if (System.getenv("JENKINS_HOME") != null) {
	        // Jenkins environment
	        chromeDriverPath = "C:/ProgramData/Jenkins/tools/neww/chromedriver.exe";
	    } else {
	        // Local environment (set the path of local machine)
	        chromeDriverPath = "C:\\Users\\91701\\.cache\\selenium\\chromedriver\\win64\\131.0.6778.86\\chromedriver.exe"; // update this path
	    }
